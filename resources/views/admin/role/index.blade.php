        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div class="page-title-left">
                    ...
                    <a href="{{route('users')}}" class="btn btn-info btn-sm" title="User Panel">User Panel</a>
                    @endcan
                    @can('view_role', $permission)
                    <a href="{{route('roles')}}" class="btn btn-info btn-sm active" title="Permission Panel">Permission Panel</a>
                    @endcan
                </div>
                <h4 class="mb-sm-0 font-size-18">Role Permission Panel</h4>
            </div>
        </div>
    </div>
    <div class="row">
                            ...
                            <div class="row d-flex align-items-center border px-2 py-1 justify-content-between">
                                ...
                                <div class="col-md-4">
                                    <span>
                                        ...
                                        </a> @endcan @can('edit_role', $permission) | <form id="delete-form-{{ $role->slug }}" method="post" action="{{route('role-delete',$role->slug)}}" style="display: none;">
                                            @csrf
                                        ...
                                        <button class="btn btn-blue btn-sm text-primary show_hide{{$role->role_id}}">Show Permissions</button>
                                        @endcan
                                    </span>
                                </div>
                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-9">
                                                        <ul class="list-inline" style="margin-left: 30px;">
                                                            ...
                                                            <li class="list-inline-item">
                                                                <?php $select = DB::table('permission_roles')->where('role_id', $role->role_id)->where('permission_id', $value->permission_id)->get(); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" id="addUpdateRole">
                    ...
                    <div class="mb-3">
                        <label for="role-name" class="col-form-label">Role Name <sup class="compulsayField">*</sup> <span class="spanColor name_error"></span></label>
