                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="customer_id" value="<?= isset($_GET['customer_id']) ? $_GET['customer_id'] : '' ?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="date" value="<?= isset($_GET['date']) ? $_GET['date'] : '' ?>" />
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-6">
                                                <div class="form-group mb-3">
                                                    <label class="form-label">Order Id</label>
                                                    <input type="text" class="form-control" name="order_id" value="<?= isset($_GET['order_id']) ? $_GET['order_id'] : '' ?>" />
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-success waves-effect waves-light" onclick="showModal('{{ $order->rider->customer_id }}', '{{ $order->rider->profile_type }}', '{{ $order->slug }}');">Assign</a>
                                            @else
                                            <a href="javascript:void(0)" class="btn btn-secondary disabled waves-effect waves-light">Assign</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
                        ...
                        <div class="isVendor">
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input id="autocomplete" name="cluster_manager" type="text" class="floating-input form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    <label for="address serach" class="col-form-label">TL Name</label>
                                    <input id="autocomplete" name="tl_name" type="text" class="floating-input form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    <label for="address serach" class="col-form-label">Client Name</label>
                                    <input id="autocomplete" name="client_name" type="text" class="floating-input form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group mb-2">
