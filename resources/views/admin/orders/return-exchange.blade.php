                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="cust_id" value="<?= isset($_GET['cust_id']) ? $_GET['cust_id'] : '' ?>" />
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-6">
                                                <div class="form-group mb-3">
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="ch_no" value="<?= isset($_GET['ch_no']) ? $_GET['ch_no'] : '' ?>" />
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-6">
                                                <div class="form-group mb-3">
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control selectBasic" name="ur">
                                                        ...
                                                        <option value="{{$key}}" <?= (isset($_GET['ur']) && $key == $_GET['ur']) ? 'selected' : '' ?>>{{$ur}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('return-view', $record->slug) }}" title="Return" style="cursor: pointer;margin-right: 5px;">{{ $record->request_for_name }}
                                            </a>
                                            @elseif ($record->request_for == 2 && $record->status_id == 2)
                                            <a href="{{ route('exchange-view', $record->slug) }}" title="Exchange" style="cursor: pointer;margin-right: 5px;">{{ $record->request_for_name }}
                                            </a>
                                            @else
