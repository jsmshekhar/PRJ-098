            ...
            <div class="card">
                ...
                <div class="card-body border-0">
                    <div class="table-rep-plugin">
                        <form method="post" enctype="multipart/form-data" id="createProductForm" action="{{ route('return-evs', $records->slug) }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="example-title-input" class="form-label">Return Date<span class="spanColor return_date"></span></label>
                                    <input class="form-control" type="text" name="Return Date" id="return_date" value="{{ date('m/d/Y') }}" readonly>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="example-title-input" class="form-label">Damage <span class="spanColor damage"></span></label>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="example-title-input" class="form-label">Security Amount <span class="spanColor security_amount_error"></span></label>
                                    <input class="form-control" type="text" name="security_amount" id="security_amount" value="{{ $records->order->security_ammount }}" readonly>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="example-title-input" class="form-label">Refund Date<span class="spanColor refund_date"></span></label>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" type="number" name="damage_cost" id="damage_cost" oninput="updateAmount()">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="refund_amount" class="form-label">Refund Amount
                                        <span class="spanColor" id="orefund_amount_error"></span></label>
                                    <input class="form-control" type="text" name="refund_amount" id="refund_amount" value="{{ $records->order->security_ammount }}" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-3">
