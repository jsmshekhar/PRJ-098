                ...
                <div class="card-body">
                    <div class="detail_cnt">
                        <div class="profil_img mb-3 new_active_profile">
                            <img class="img-thumbnail rounded-circle avatar-xl" alt="200x200" src="{{ asset('public/assets/images/users/avatar-3.jpg') }}" data-holder-rendered="true">
                        ...
                        <p class="text-center text-dot-new">KYC Status :
                            <span class="dot_btn" onclick="showModal('targetModal');">{{ $rider->kyc_status_name }}</span>
                        </p>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="detail_cnt line-bt-16">
                            ...
                            ?>
                            <button onclick="mobilizedEv(<?= $productId ?>, <?= $gpsEmeiNumber ?>, <?= $riderId ?>, 'm')" class="btn btn-success waves-effect waves-light mobilizedEvMap">Mobilized
                                Now</button>
                            <button onclick="imMobilizedEv(<?= $productId ?>, <?= $gpsEmeiNumber ?>, <?= $riderId ?>, 'im')" class=" btn btn-danger waves-effect waves-light imMobilizedEvMap">Immobilized
                                Now</button>
                                    ...
                                    <table class="table mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ asset('public/upload/documents/' . $document->front_pic) }}" download>
                                                        <img src="{{ asset('public/assets/images/icons/light_download.svg') }}" alt="">
                                                    </a>
                                                </td>
                                            </tr>
                                            @endforeach
...
<input class="knob" data-linecap=round data-fgColor="#01992366" value="100" data-skin="tron" data-angleOffset="1000" data-readOnly=true data-thickness=".1" />
</div>
</div>
</div><!-- end card-body -->
</div><!-- end card -->
                ...
                @can('pay_rent', $permission)
                    @if (!empty($orderDetails))
                        @if (isset($orderDetails->transaction_mode) &&
                            ...
                            <a href="javascript:void(0);" class="btn btn-link-under" onclick="showModal('rentModel');">
                                Pay Rent
                            </a>
                        @endif
                    @endif
...
{{-- Change KYC status --}}
<div class="modal fade" id="targetModal" role="dialog" aria-labelledby="modalLabel" data-keyboard="false" data-bs-backdrop="static" data-bs-keyboard="false">
...
<div class="modal fade" id="detailModal" role="dialog" aria-labelledby="modalLabel" data-keyboard="false" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modelWidth" role="document">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                ...
                                <input id="fcustomer_id" type="text" class="floating-input form-control" autocomplete="off" value="{{ 'CUS' . $rider->customer_id }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Name</label>
                                <input id="fname" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->name }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Email Id</label>
                                <input id="femail" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->email }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Mobile Number</label>
                                <input id="fphone" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->phone }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Alternate Mobile Number</label>
                                <input id="falternate_phone" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->alternate_phone }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Current Address</label>
                                <input id="fcurrent_address" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->current_address }}" name="current_address">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Permanent Address</label>
                                <input id="fpermanent_address" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->permanent_address }}" name="permanent_address">
                            </div>
                        </div>
                        <input type="hidden" name="rider_slug" value="{{ $rider->slug }}">
                    </div>
...
?>
<div class="modal fade" id="rentModel" role="dialog" aria-labelledby="modalLabel" data-keyboard="false" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modelWidth" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4>Pay Rent</h4>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                ...
                                <input name="paying_ammount" type="number" value="{{ $paymentDetails['payble_rent'] }}" class="floating-input form-control" autocomplete="off" id="paying_ammount" readonly>
                            </div>
                        </div>
                        <input type="hidden" name="rider_slug" value="{{ $rider->slug }}">
