                ...
                <div class="col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="detail_cnt line-bt-16">
                            ...
                            <button onclick="mobilizedEv($riderEv->product_id, $riderEv->gps_emei_number, $riderEv->rider_id, 'm')" class="btn btn-success waves-effect waves-light mobilizedEvMap">Mobilized
                                Now</button>
                            <button onclick="imMobilizedEv($riderEv->product_id, $riderEv->gps_emei_number, $riderEv->rider_id, 'im')" class=" btn btn-danger waves-effect waves-light imMobilizedEvMap">Immobilized
                                Now</button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                ...
                                <input id="autocomplete" type="text" class="floating-input form-control" autocomplete="off" value="{{ 'CUS' . $rider->customer_id }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Name</label>
                                <input id="autocomplete" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->name }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Email Id</label>
                                <input id="autocomplete" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->email }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Mobile Number</label>
                                <input id="autocomplete" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->phone }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Alternate Mobile Number</label>
                                <input id="autocomplete" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->alternate_phone }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Current Address</label>
                                <input id="autocomplete" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->current_address }}" name="current_address">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="address serach" class="col-form-label">Permanent Address</label>
                                <input id="autocomplete" type="text" class="floating-input form-control" autocomplete="off" value="{{ $rider->permanent_address }}" name="permanent_address">
                            </div>
                        </div>
                        <input type="hidden" name="rider_slug" value="{{ $rider->slug }}">
                    </div>
