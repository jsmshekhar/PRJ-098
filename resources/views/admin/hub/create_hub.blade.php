                                                    ...
                                                    <tr>
                                                        <td>
                                                            @can('hub_view', $permission)
                                                                <a href="{{ route('hub-view', ['slug' => $hub->slug, 'param' => 'vehicle']) }}"
                                                                    title="View Hub" style="cursor: pointer;margin-right: 5px;"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" id="addUpdateHub" autocomplete="off">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-2">
                                <label for="hublimit" class="col-form-label">Hub Limit &nbsp;<span
