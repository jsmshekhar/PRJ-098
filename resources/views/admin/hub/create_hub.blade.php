...
@section('content')
                                ...
                                <h2 class="accordion-header" id="headingOne">
                                    ...
                                    <div class="collaps_btns">
                                        <button type="button" class="btn btn-outline-danger waves-effect waves-light"
                                            onclick="refreshPage('<?= url()->current() ?>');">Clear</button>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="hub_capacity"
                                                            value="<?= isset($_GET['hub_capacity']) ? $_GET['hub_capacity'] : '' ?>" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="vehicle"
                                                            value="<?= isset($_GET['vehicle']) ? $_GET['vehicle'] : '' ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            @can('hub_view', $permission)
                                                                <a href="{{ route('hub-view', $hub->slug) }}" title="View Hub"
                                                                    style="cursor: pointer;margin-right: 5px;"
                                                                    target="_blank">{{ $hub->hubId }}
                                                                </a>
                                                            @endcan
                                                        </td>
                                                        <td>{{ $hub->city }}</td>
                                                        ...
                                                        <td>
                                                            @can('edit_hub', $permission)
                                                                <a class="hubModelForm" data-toggle="modal"
                                                                    data-hub_id="{{ $hub->hub_Id }}"
                                                                    data-hubid="{{ $hub->hubId }}"
                                                                    data-city="{{ $hub->city }}"
                                                                    data-state="{{ $hub->state }}"
                                                                    data-country="{{ $hub->country }}"
                                                                    data-slug="{{ $hub->slug }}"
                                                                    data-address1="{{ $hub->address_1 }}"
                                                                    data-address2="{{ $hub->address_2 }}"
                                                                    data-fulladdress="{{ $hub->full_address }}"
                                                                    data-zipcode="{{ $hub->zip_code }}"
                                                                    data-hublimit="{{ $hub->hub_limit }}" title="Edit Hub"
                                                                    style="cursor: pointer;margin-right: 5px;"><i
                                                                        class="fa fa-edit"></i>
                                                                </a>
                                                            @endcan
                                                            @can('hub_view', $permission)
                                                                | <a href="{{ route('hub-view', $hub->slug) }}"
                                                                    title="View Hub"
                                                                    style="cursor: pointer;margin-right: 5px;"
                                                            ...
                                                            @can('delete_hub', $permission)
                                                                | <form id="delete-form-{{ $hub->slug }}" method="post"
                                                                    action="{{ route('hub-delete', $hub->slug) }}"
                                                                    style="display: none;">
                                                                    @csrf
                                                                    {{ method_field('POST') }} <!-- delete query -->
                                                                </form>
                                                                <a href="" class="shadow btn-xs sharp"
                                                                    onclick="
    ...
    <!-- Add role model -->
    <div class="modal fade" id="hubModelForm" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" id="addUpdateHub" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group mb-2">
                                    <label for="hubid" class="col-form-label">Hub Id <sup
                                            class="compulsayField">*</sup> <span
                                            class="spanColor hubid_error"></span></label>
                                    <input type="text" name="hubId" class="form-control" id="hubId"
                                        value="{{ $hubId }}" readonly>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group mb-2">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-2">
                                <label for="hublimit" class="col-form-label">Hub Limit &nbsp;<span class="spanColor"
                                        id="hub_errors"></span></label>
