                                            ...
                                            <tbody>
                                                @foreach ($hubs as $key => $hub)
                                                    <tr>
                                                        <td>
                                                            @can('hub_view', $permission)
                                                                <a href="{{ route('hub-view', ['slug' => $hub->slug, 'param' => 'vehicle']) }}"
                                                                    title="View Hub"
                                                                    style="cursor: pointer;margin-right: 5px;">{{ $hub->hubId }}
                                                                </a>
                                                            @endcan
                                                        </td>
                                                        <td>{{ $hub->city }}</td>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    @can('edit_hub', $permission)
                                                                        <a class="dropdown-item hubModelForm"
                                                                            data-toggle="modal"
                                                                            ...
                                                                            data-hublimit="{{ $hub->hub_limit }}"
                                                                            data-latitude="{{ $hub->latitude }}"
                                                                            data-longitude="{{ $hub->longitude }}"
                                                                            title="Edit Hub"
                                                                    ...
                                                                    @can('hub_view', $permission)
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('hub-view', ['slug' => $hub->slug, 'param' => 'vehicle']) }}"
                                                                            title="View Hub"
                                                                            style="cursor: pointer;margin-right: 5px;"><i
                                                        ...
                                                        "
                                                                            title="delete">
                                                                            <i class="fa fa-trash" style="color:#d74b4b;">
                                                                                Delete</i>
                                                                        </a>
                                                                    @endcan
                                                                </div>
