                ...
                <form method="post" enctype="multipart/form-data" id="addUpdateUser">
                    ...
                    <div class="form-group mb-1">
                        ...
                        <div class="form-group mb-1">
                            ...
                            <input type="text" name="first_name" class="form-control readOnlyClass" id="first_name" readonly>
                        </div>
                        <div class="form-group mb-1">
                            <label for="role-name" class="col-form-label">Last Name</label>
                            <input type="text" name="last_name" class="form-control readOnlyClass" id="last_name" readonly>
                        </div>
                        <div class="form-group mb-1">
                            <label for="role-name" class="col-form-label">Email <sup class="compulsayField">*</sup> <span class="spanColor email_error"></span></label>
                            <input type="text" name="email" class="form-control readOnlyClass" id="email" readonly>
                        </div>
                        <div class="form-group mb-1">
