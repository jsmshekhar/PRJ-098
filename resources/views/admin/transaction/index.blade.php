                                            ...
                                            <div class="row">
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="tr_id"
                                                            value="<?= isset($_GET['tr_id']) ? $_GET['tr_id'] : '' ?>">
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label class="form-label">Customer ID</label>
                                                        <input type="text" class="form-control" name="cu_id"
                                                            value="<?= isset($_GET['cu_id']) ? $_GET['cu_id'] : '' ?>">
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select class="form-control selectBasic" name="p_type">
                                                            ...
                                                            @foreach ($payTypes as $key => $pay_type)
                                                                <option value="{{ $key }}"
                                                                    <?= isset($_GET['p_type']) && $key == $_GET['p_type'] ? 'selected' : '' ?>>
                                                                    {{ $pay_type }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select class="form-control selectBasic" name="p_mode">
                                                            ...
                                                            @foreach ($payModes as $key => $pay_mode)
                                                                <option value="{{ $key }}"
                                                                    <?= isset($_GET['p_mode']) && $key == $_GET['p_mode'] ? 'selected' : '' ?>>
                                                                    {{ $pay_mode }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select class="form-control selectBasic" name="p_status">
                                                            ...
                                                            @foreach ($payStatus as $key => $pay_status)
                                                                <option value="{{ $key }}"
                                                                    <?= isset($_GET['p_status']) && $key == $_GET['p_status'] ? 'selected' : '' ?>>
                                                                    {{ $pay_status }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <button type="button" class="btn btn-success waves-effect waves-light"
                                        onclick="exportData('<?= config('table.REF_TABLE.TRANSACTIONS') ?>');">
                                            ...
                                            <tbody>
                                                @foreach ($transactions as $key => $transaction)
                                                    <tr>
                                                        ...
                                                        <td>CUS{{ $transaction->customer_id }}<br><i><span
                                                                    class="d-flex heading_label"> {{ $transaction->name }}
                                                                </span></i></td>
                                                        <td>Rs {{ $transaction->transaction_ammount }}</td>
                                                        <td>
                                                            @if ($transaction->transaction_type == 1)
                                                                <label class="text-success m-0">Credit</label>
                                                            @else
                                                                <label class="text-danger m-0">Debit</label>
                                                            @endif
                                                        </td>
