...
@section('content')
                ...
                <div class="card">
                    <div class="card-header border-bottom bg-white">
                        ...
                        <div class="btn-card-header">
                            <a class="btn btn-success waves-effect waves-light accessoriesModelForm" data-toggle="modal"
                                title="Add Accessories">Add New Accessories</a>
                        </div>
                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach ($accessorieses as $key => $accessories)
                                                <tr>
                                                    <td><img id="selectedImage"
                                                            src="{{ asset('public/upload/accessories/' . $accessories->image) }}"
                                                    ...
                                                    <td>₹{{ $accessories->price ? $accessories->price * $accessories->no_of_item : 0 }}
                                                    </td>
                                                    <td>
                                                        <a class="accessoriesModelForm" data-toggle="modal"
                                                            data-category="{{ $accessories->accessories_category_id }}"
                                                            data-slug="{{ $accessories->slug }}"
                                                            data-price="{{ $accessories->price }}"
                                                            data-title="{{ $accessories->title }}"
                                                            data-item="{{ $accessories->no_of_item }}"
                                                            data-image="{{ $accessories->image }}" title="Edit Accessories"
                                                            style="cursor: pointer;margin-right: 5px;">Edit
                                                        </a>
                                                    </td>
                                                </tr>
                                            @endforeach
    ...
    <div class="modal fade" id="accessoriesModelForm" role="dialog" aria-labelledby="modalLabel" data-keyboard="false"
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select class="form-control selectBasic" name="accessories_category"
                            ...
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    <label for="no_of_item" class="form-label ">No. of Items &nbsp;<span
                            ...
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    <label for="example-title-input" class="form-label">Amount Per Item &nbsp; <span
                                            class="spanColor onlyDigit_error"> </span></label>
            ...
            $('.accessoriesModelForm').click(function() {
                ...
                if (slug) {
                    ...
                    if (image) {
                        ...
                        $("#ImageID").html('<img class="upload_des_preview clickable selectedImage" src="' +
                            imageUrl + '" alt="accessories image">');
                    }
                    $("#slug").val(slug);
                    $("#title").val(title);
                    $("#no_of_item").val(item);
