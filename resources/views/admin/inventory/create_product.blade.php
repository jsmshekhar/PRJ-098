            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom bg-white">
                        ...
                        <h4> Add Product <span class="d-flex heading_label"> {{ ucfirst(request()->route('param')) }} </span>
                        </h4>
                        <div class="nav_cust_menu">
                            <ul>
                                <li><a href="{{ route('products', request()->route('param')) }}" class="active"
                                        title="Products">Go Back</a></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="example-title-input" class="form-label">EV Number* &nbsp; <span
                                                class="spanColor ev_number_error"></span></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="example-title-input" class="form-label">Chassis Number* &nbsp; <span
                                                class="spanColor chassis_number_error"></span></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control selectBasic" name="ev_type_id" id="ev_type_id">
                                            ...
                                            @foreach ($ev_types as $key => $ev_type)
                                                <option value="{{ $ev_type->range }}" data-value1="{{ $ev_type->speed }}"
