...
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                ...
                @endcan --}}
                        ...
                        <li><a href="{{ route('product-categories') }}" class="active" title="Accessories">Accessories</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="card-header border-bottom bg-white">
                        ...
                        <div class="btn-card-header">
                            @can('add_product_type', $permission)
                                <a class="btn btn-success waves-effect waves-light categoryModelForm" data-toggle="modal"
                                    title="Add Hub">Add New Category</a>
                            @endcan
                        </div>
                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @can('edit_product_type', $permission)
                                                            <a class="categoryModelForm" data-toggle="modal"
                                                                data-category_name="{{ $pc->product_category_name }}"
                                                                data-slug="{{ $pc->slug }}"
                                                                data-serial="{{ $pc->serial_number }}"
                                                                data-item="{{ $pc->item_in_stock }}"
    ...
    <div class="modal fade" id="categoryModelForm" role="dialog" aria-labelledby="modalLabel" data-keyboard="false"
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group mb-2">
                                    <label for="product_category_name" class="col-form-label">Product Category Name <sup
                                            class="compulsayField">*</sup> <span
                                            class="spanColor product_category_name_error"></span></label>
                            ...
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    <label for="item_in_stock" class="col-form-label ">Item In Stock &nbsp;<span
                                            class="spanColor onlyDigit_error" id="item_in_stock_errors"></span></label>
                                    <input type="text" name="item_in_stock" class="form-control onlyDigit"
                                        id="item_in_stock">
                                </div>
                            </div>
                            <div class="col-12">
