                        ...
                        <form method="post" enctype="multipart/form-data" id="createProductForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" type="text" name="ev_number" id="ev_number" value="{{$product->ev_number}}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="example-title-input" class="form-label">Chassis Number* &nbsp; <span class="spanColor chassis_number_error"></label>
                                    <input class="form-control" type="text" name="chassis_number" id="chassis_number" value="{{$product->chassis_number}}">
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control selectBasic" name="rent_cycle" id="rent_cycle">
                                        ...
                                        <option value="{{$rent_cycle}}" @if($rent_cycle==$product->rent_cycle) selected @endif>{{$rent_cycle == 15 ? "15 Days" : "30 Days"}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control selectBasic" name="battery_type" id="battery_type">
                                        ...
                                        <option value="{{$battery_type}}" @if($battery_type==$product->bettery_type) selected @endif>{{$battery_type == 1 ? "Swappable" : "Fixed"}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control selectBasic" name="hub_id" id="hub_id">
                                        ...
                                        <option value="{{$hub->hub_id}}" @if($hub->hub_id==$product->hub_id) selected @endif>{{$hub->city}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
