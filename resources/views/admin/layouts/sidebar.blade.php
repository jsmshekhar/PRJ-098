             ...
             <ul class="metismenu list-unstyled" id="side-menu">
                 ...
                 <li class="{{ Request::routeIs('live-tracking') ? 'mm-active' : '' }}">
                     <a href="{{ route('live-tracking') }}"
                         class="{{ Request::routeIs('live-tracking') ? 'active' : '' }}">
                 ...
                 @can('hub_list', $permission)
                     <li
                         class="{{ Request::routeIs('distributed-hubs') || Request::routeIs('hub-view') ? 'mm-active' : '' }}">
                         <a href="{{ route('distributed-hubs') }}"
                             class="{{ Request::routeIs('distributed-hubs') || Request::routeIs('hub-view') ? 'active' : '' }}">
                 ...
                 @endcan
                 <li
                     class="{{ Request::routeIs('customer-managements') || Request::routeIs('customer-view') ? 'mm-active' : '' }}">
                     <a href="{{ route('customer-managements') }}"
                         class="{{ Request::routeIs('customer-managements') || Request::routeIs('customer-view') ? 'active' : '' }}">
                 ...
                 @can('view_user', $permission)
                     <li class="{{ Request::routeIs('users') || Request::routeIs('roles') ? 'mm-active' : '' }}">
                         <a href=" {{ route('users') }}"
                             class="{{ Request::routeIs('users') || Request::routeIs('roles') ? 'active' : '' }}">
                 ...
                 @can('view_inventry', $permission)
                     <li
                         class="{{ Request::routeIs('products', 'corporate') || Request::routeIs('product-create') || Request::routeIs('product-edit') ? 'mm-active' : '' }}">
                         <a href="{{ route('products', 'corporate') }}"
                             class="{{ Request::routeIs('products', 'corporate') || Request::routeIs('product-create') || Request::routeIs('product-edit') ? 'active' : '' }}">
                 ...
                 @can('view_notification', $permission)
                     <li
                         class="{{ Request::routeIs('notifications') || Request::routeIs('create-notification') || Request::routeIs('edit-notification') ? 'mm-active' : '' }}">
                         <a href="{{ route('notifications') }}"
                             class="{{ Request::routeIs('notifications') || Request::routeIs('create-notification') || Request::routeIs('edit-notification') ? 'active' : '' }}">
                 ...
                 <li class="{{ Request::routeIs('transaction-management') ? 'mm-active' : '' }}">
                     <a href="{{ route('transaction-management') }}"
                         class="{{ Request::routeIs('transaction-management') ? 'active' : '' }}">
                 ...
                 @can('view_complaint', $permission)
                     <li class="{{ Request::routeIs('complain-queries') ? 'mm-active' : '' }}">
                         <a href="{{ route('complain-queries') }}"
                             class="{{ Request::routeIs('complain-queries') ? 'active' : '' }}">
                 ...
                 @can('view', $permission)
                     <li class="{{ Request::routeIs('hub-part-accessories') ? 'mm-active' : '' }}">
                         <a href="{{ route('hub-part-accessories') }}"
                             class="{{ Request::routeIs('hub-part-accessories') ? 'active' : '' }}">
                 ...
                 @can('view', $permission)
                     <li class="{{ Request::routeIs('return-exchange') ? 'mm-active' : '' }}">
                         <a href="{{ route('return-exchange') }}"
                             class="{{ Request::routeIs('return-exchange') ? 'active' : '' }}">
