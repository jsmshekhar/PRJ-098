...
@section('content')
                                            ...
                                            <div class="row">
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="hubid"
                                                            value="<?= isset($_GET['hubid']) ? $_GET['hubid'] : '' ?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="hub_loc"
                                                            value="<?= isset($_GET['hub_loc']) ? $_GET['hub_loc'] : '' ?>" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="fname"
                                                            value="<?= isset($_GET['fname']) ? $_GET['fname'] : '' ?>" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                ...
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select class="form-control selectBasic" name="aci"
                                                            id="accessoriesCategoryId">
                                                            <option value="">Select</option>
                                                            @foreach ($accessories_categories as $key => $accCat)
                                                                <option value="{{ $accCat }}"
                                                                    <?= isset($_GET['aci']) && $_GET['aci'] == $accCat ? 'selected' : '' ?>>
    ...
    <div class="modal fade" id="assignModelForm" role="dialog" aria-labelledby="modalLabel" data-keyboard="false"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data" id="assignRequestForm"
                    action="{{ route('update-accessories-hub-part') }}">
                        ...
                        <div class="form-group mb-1">
                            ...
                            <div class="form-group mb-1">
                                <label for="choices-single-no-search"
                                    class="form-label font-size-13 text-muted">Accessories Category</label>
                            ...
                            <div class="form-group mb-1">
                                <label for="role-name" class="col-form-label">Assigned Quantity &nbsp;<span
    ...
    <!-- view data -->
    <div class="modal fade" id="viewModelForm" role="dialog" aria-labelledby="modalLabel" data-keyboard="false"
        data-bs-backdrop="static" data-bs-keyboard="false">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.viewModelForm').click(function() {
                ...
                var accessories = acceessories == 1 ? "Helmet" : acceessories == 2 ? "T-Shirt" :
                    acceessories == 3 ? "Mobile Holder" : "";
                ...
                console.log(status)
                var statusId = status == 1 ? "Raised" : (status == 2 ? "Shipped" : (status == 3 ?
                    "Completed" : (status == 4 ? "Rejected" : "")));
