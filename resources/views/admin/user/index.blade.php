                                ...
                                <h2 class="accordion-header" id="headingOne">
                                    ...
                                    <div class="collaps_btns">
                                        ...
                                        @can('add_user', $permission)
                                            <a class="btn btn-success waves-effect waves-light userModelForm"
                                                data-toggle="modal" title="Add Role">Add New User</a>
                                        @endcan
                                    </div>
                                </h2>
                                                ...
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="emp_id"
                                                            value="<?= isset($_GET['emp_id']) ? $_GET['emp_id'] : '' ?>" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control selectBasic" name="role">
                                                        ...
                                                        @foreach ($roles as $key => $role)
                                                            <option value="{{ $role->role_id }}"
                                                                <?= isset($_GET['role']) && $role->role_id == $_GET['role'] ? 'selected' : '' ?>>
                                                                {{ $role->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <button type="button" class="btn btn-success waves-effect waves-light"
                                        onclick="exportData('<?= config('table.REF_TABLE.USERS') ?>');">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @can('edit_user', $permission)
                                                                <a class="userModelForm" data-toggle="modal"
                                                                    ...
                                                                    data-hubid="{{ $user->hub_id }}"
                                                                    data-rolename="{{ $user->rolename }}" title="Edit User"
                                                                    style="cursor: pointer;margin-right: 5px;"><i
                                                                        class="fa fa-edit"></i>
                                                                </a>
                                                                @endcan @can('delete_user', $permission)
                                                                | <form id="delete-form-{{ $user->slug }}" method="post"
                                                                    action="{{ route('user-delete', $user->slug) }}"
                                                                    style="display: none;">
                                                                    @csrf
                    ...
                    <form method="post" enctype="multipart/form-data" id="addUpdateUser">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-1">
                                <label for="role-name" class="col-form-label">First Name <sup
                                        class="compulsayField">*</sup> <span class="spanColor name_error"></span></label>
                            ...
                            <div class="col-md-6 form-group mb-1">
                                <label for="choices-single-no-search"
                                    class="col-form-label font-size-13 text-muted">Role</label>
                            ...
                            <div class="col-md-6 form-group mb-1">
                                <label for="choices-single-no-search"
                                    class="col-form-label font-size-13 text-muted">Hub</label>
