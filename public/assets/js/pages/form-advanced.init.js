...
flatpickr("#datepicker-basic", { defaultDate: new Date() }),
    ...
    flatpickr("#datepicker-humanfd", { altInput: !0, altFormat: "F j, Y", dateFormat: "Y-m-d", defaultDate: new Date() }),
    flatpickr("#datepicker-minmax", { minDate: "today", defaultDate: new Date(), maxDate: new Date().fp_incr(14) }),
    ...
    flatpickr("#datepicker-multiple", { mode: "multiple", dateFormat: "Y-m-d", defaultDate: new Date() }),
    flatpickr("#datepicker-range", { mode: "range", defaultDate: new Date() }),
    flatpickr("#datepicker-timepicker", { enableTime: !0, noCalendar: !0, dateFormat: "H:i", defaultDate: new Date() }),
